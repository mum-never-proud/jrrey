...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=l;var t=require("./parser");function e(t,e){return o(t)||r(t,e)||a(t,e)||n()}function n(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function r(t,e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(t)){var n=[],r=!0,o=!1,i=void 0;try{for(var a,u=t[Symbol.iterator]();!(r=(a=u.next()).done)&&(n.push(a.value),!e||n.length!==e);r=!0);}catch(s){o=!0,i=s}finally{try{r||null==u.return||u.return()}finally{if(o)throw i}}return n}}function o(t){if(Array.isArray(t))return t}function i(t,e){var n;if("undefined"==typeof Symbol||null==t[Symbol.iterator]){if(Array.isArray(t)||(n=a(t))||e&&t&&"number"==typeof t.length){n&&(t=n);var r=0,o=function(){};return{s:o,n:function(){return r>=t.length?{done:!0}:{done:!1,value:t[r++]}},e:function(t){throw t},f:o}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var i,u=!0,s=!1;return{s:function(){n=t[Symbol.iterator]()},n:function(){var t=n.next();return u=t.done,t},e:function(t){s=!0,i=t},f:function(){try{u||null==n.return||n.return()}finally{if(s)throw i}}}}function a(t,e){if(t){if("string"==typeof t)return u(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);return"Object"===n&&t.constructor&&(n=t.constructor.name),"Map"===n||"Set"===n?Array.from(t):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?u(t,e):void 0}}function u(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,r=new Array(e);n<e;n++)r[n]=t[n];return r}function s(n){var r=this,o=(0,t.parseTranscripts)(n);"cmd"===this.mode?function(){for(var t=new Map,n=function(e){var n=o[e].trim();r.commands.forEach(function(e,r){var o=null;e.phrase instanceof RegExp?o=e.phrase.exec(n):e.phrase===n&&(o=n),o&&t.set(r,t.get(r)||[]).get(r).push(o)})},a=0;a<o.length;a+=1)n(a);if(t.size){var u,s=i(t.entries());try{for(s.s();!(u=s.n()).done;){var l=e(u.value,2),c=l[0],f=l[1];r.commands[c].callback(f)}}catch(y){s.e(y)}finally{s.f()}}else"function"==typeof r.events.fallback&&r.events.fallback(o)}():"function"==typeof this.events.dictate&&this.events.dictate(o)}function l(t){var e=this;if(this.keepAlive&&"end"===t.type&&this.listeningSince)Date.now()-Number(this.listeningSince)<1e3?window.setTimeout(function(){return e.start()},1e3):this.start();else switch(t.type){case"result":s.call(this,t);break;default:var n=this.events[t.type];"function"==typeof n&&n(t)}}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=o(require("../constants/speech-recognition-options"));function o(e){return e&&e.__esModule?e:{default:e}}var n=function(){var o=window.SpeechRecognition||window.webkitSpeechRecognition||window.mozSpeechRecognition||window.msSpeechRecognition||window.oSpeechRecognition;return o?Object.assign(new o,e.default):(
// eslint-disable-next-line no-console
console.warn("SpeechRecognition not supported"),null)}();exports.default=n;
...
"use strict";var e=require("./utils/assert"),t=require("./utils/parser"),n=s(require("./utils/speech-event-handlers")),i=s(require("./utils/speech-recognition")),r=s(require("./constants/speech-events"));function s(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function u(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function o(e,t,n){return t&&u(e.prototype,t),n&&u(e,n),e}var l=Symbol("speech event handler"),c=/* */function(){function s(){a(this,s)}return o(s,[{key:"init",value:function(){var e=this,s=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(this.listeningSince)throw Error("an instance of jrrey is already running");return this.events=s.events||{},this.commands=(0,t.parseCommands)(s.commands),this.mode=s.mode||"cmd",this.keepAlive=s.keepAlive||!0,this[l]=n.default.bind(this),r.default.forEach(function(t){i.default.addEventListener(t,e[l])}),this}},{key:"start",value:function(){return this.listeningSince=Date.now(),i.default.abort(),window.setTimeout(function(){return i.default.start()}),this}},{key:"stop",value:function(){return this.listeningSince=null,i.default.stop(),this}},{key:"onEvent",value:function(t,n){return(0,e.assertString)(t),(0,e.assertFunction)(n),this.events[t]=n,this}},{key:"offEvent",value:function(t){return t?((0,e.assertString)(t),delete this.events[t]):this.events={},this}},{key:"onCommand",value:function(t,n){return(0,e.assertStringOrRegExp)(t),(0,e.assertFunction)(n),this.commands.push({phrase:t,callback:n}),this}},{key:"offCommand",value:function(t){return t?((0,e.assertStringOrRegExp)(t),this.commands=this.commands.filter(function(e){return String(e.phrase)!==String(t)})):this.commands=[],this}}]),s}();module.exports=i.default?new c:null;
...
//# sourceMappingURL=/jrrey.min.js.map